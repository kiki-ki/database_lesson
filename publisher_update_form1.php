...
更新したい出版社を選択して送信ボタンを押してください。<BR><BR>

<FORM ACTION="publisher_update_form2.php" METHOD="GET">
...
for ( $j=0; $j<$rows; $j++ )
{
	...
	// 出版社番号と選択のためのラジオボタンを表示
	$data = pg_fetch_result( $result, $j, 0 );
	print( "<TD> <INPUT TYPE=\"radio\" NAME=\"publisher_id\" VALUE=\"$data\"> $data </INPUT> </TD>\n" );
...
// 検索件数を表示
print( "以上、$rows 社の出版社が登録されています。<BR>\n" );
